  ...
  return (
    <div className="goddessmode-toggle">
      <button 
        ...
        title={isGoddessMode ? 'GODDESSMODE+ aktiviert' : 'GODDESSMODE+ aktivieren'}
      >
      ...
      <style jsx>{`
        ...
        .goddessmode-button {
          ...
          color: var(--text);
          border: 2px solid ${isGoddessMode ? 'var(--hl-gold)' : 'rgba(255, 255, 255, 0.2)'};
          border-radius: 24px;
          padding: 10px 18px;
          cursor: pointer;
          display: flex;
        ...
        @keyframes goddess-pulse {
          ...
          50% {
            box-shadow: 0 0 40px var(--hl-gold), 0 0 60px var(--brand-amethyst);
          }
        }

        .goddess-icon {
          font-size: 18px;
          animation: ${isGoddessMode ? 'goddess-sparkle 1.5s ease-in-out infinite' : 'none'};
        }
